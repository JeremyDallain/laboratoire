...
inputPseudo.addEventListener("input", function(event){
...
function showAlertTimeOut (){
    divTime.innerHTML = "";
    divParameters.innerHTML = `Temps écoulé <strong>${joueur}</strong>! Vous avez réalisé un score de <strong>${totalPoints}</strong> Points.`;
    divParameters.classList.add("alert");
    divParameters.classList.add("alert-warning");
...
function showAlertBravo() {
    clearInterval(time);
    divTime.innerHTML = "";
    divParameters.innerHTML = `Bravo <strong>${joueur}</strong>! Vous avez réalisé un score de <strong>${totalPoints}</strong> Points.`;
    divParameters.classList.add("alert");
    divParameters.classList.add("alert-success");
    start.innerHTML = "Try Again";
    start.classList.remove("d-none");
    inputPseudo.classList.remove("d-none");
    hideWindArrow();
