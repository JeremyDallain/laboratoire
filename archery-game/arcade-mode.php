...
<div class="text-center">
  ...
  <h6 class="bg-primary text-light rounded pb-2">Mode Arcade</h6>
  ...
  <input id="pseudo" type="text" placeholder="votre nom" class="m-1"><br>
...
<script src="scripts/arcade_mode.js"></script>
